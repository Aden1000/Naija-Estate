...
this.onresize=function(){
    document.querySelectorAll(".productPic img").forEach(function(item){
        fitPic(item);
    })
}
...
function fitPic(pic){
    // if(pic.naturalWidth/pic.naturalHeight>pic.parentElement.clientWidth/pic.parentElement.clientHeight){
...
function showProductView(){
    ...
    setTimeout(function(){
        ...
        document.body.querySelectorAll("#productView>.mainContainer>*:not(#productLoading,.banner)").forEach(function(item){
...
function showContact(){
    ...
    var product=getByQuery("#productView");
    addClass(main,null,"frozen");
    addClass(product,null,"shift");
    ...
    if(lastHash!="#contactPic"){
        loadContact=setTimeout(function(){
            ...
            addClass(getByQuery("#productView>.mainContainer"),null,"shift")
        },2000);
    }
    else{
...
function hideContact(){
    ...
    removeClass(product,null,"shift");
    removeClass(getById("showContact"),null,"shift");
    removeClass(getByQuery("#productView>.mainContainer"),null,"shift")
...
function hashChanged(hash,url){
    switch(hash){         
        ...
        case "#productPic":
            zoomPic(getByQuery("#productView .productPic"));
            lastHash="#contact";
            break;
    }
}
